...
%\autoref{arch_compare} demonstrates the comparison between \textsc{Aurora} and other architectures. 
...
AuditedIO~\cite{DBLP:conf/apsys/BalakrishnanCBS17} leverages SGX and a kernel module to implement verifiable data storage for disk I/O operations. However, it requires programmable SSD devices and modifies their firmware. % moreover, its kernel module is not isolated nor verified. 
