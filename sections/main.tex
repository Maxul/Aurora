...
Finally, %to directly measure the overhead introduced by \textsc{Aurora}'s infrastructure, 
we set the synchronize flag to \textsf{FULL} to avoid the uncertainty of I/O caching.
